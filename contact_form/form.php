                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="text-white mb-0 text-uppercase">contact create form</h4>
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-4">
                                ...
                                <input type="number" id="phone" name="phone" min="11" class="form-control" value="<?php echo old("phone") ?>">
                            ...
                            <div class="form-group mt-4">
                                ...
                                <input type="file" id="file" name="upload" accept=".jpg,.jpeg,.png" class="form-control" value="<?php echo old("upload") ?>">
